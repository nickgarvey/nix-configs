...
{
  lanHosts = [
    { hostname = "talos";         mac = "34:5a:60:b6:5f:90"; ipv4 = "10.28.8.80";    ipv6 = "2001:470:482f::5"; }
    ...
    { hostname = "wabbajack";     mac = "9c:bf:0d:01:0e:95"; ipv4 = "10.28.1.10";    ipv6 = "2001:470:482f::10"; }      # garage container /64: 2001:470:482f:202::/64 (gw ::202::1 on vmbr0)
