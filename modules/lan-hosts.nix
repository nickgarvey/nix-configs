...
#   :100-:1ff = k8s pod CIDRs (/56, native routing, no masquerade), :3+ = future VLANs
{
  lanHosts = [
    ...
    { hostname = "k3s-dragon";    mac = "78:55:36:00:47:f2"; ipv4 = "10.28.15.2";    ipv6 = "2001:470:482f::22"; podCIDR = "2001:470:482f:101::/64"; }
    { hostname = "k3s-goat";      mac = "78:55:36:00:4d:80"; ipv4 = "10.28.15.3";    ipv6 = "2001:470:482f::23"; podCIDR = "2001:470:482f:102::/64"; }
