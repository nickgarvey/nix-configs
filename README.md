...
`microatx` has 128GB of DDR4 ECC RAM, so it acts as a storage and VM server.
...
| [`microatx`](hosts/microatx) | ASRock Industrial IMB-X1314 | Intel i5-12600K | 128 GB | iGPU (UHD 770) | Samsung 980 Pro 2 TB NVMe + 2× Seagate 8 TB HDD |
